            ...
            <div className="practice-container">
                <div className="config-card" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
                        ...
                        {/* Full dictation: read each new question aloud once */}
                        <button
                            style={{
                                padding: '1.5rem',
                                borderRadius: '12px',
                            ...
                            onClick={() => navigate('/writing/full')}
                        >
                            <span style={{ fontSize: '24px' }}>📝</span>
                            <div style={{ fontSize: '18px', fontWeight: '600' }}>{t('writingHub.full.title')}</div>
                            <div style={{ fontSize: '14px', color: 'var(--color-text-secondary)' }}>
                                {t('writingHub.full.desc')}
                            </div>
                        </button>
