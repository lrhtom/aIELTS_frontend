...
export const readingDetails: typeof zh.readingDetails = {
  ...
  noConfigTitle: 'No reading task to work on',
  noConfigDesc: 'A reading task has to be configured first — vocabulary, difficulty and question type. Opening this URL directly will not generate one, so no AT is spent by accident.',
